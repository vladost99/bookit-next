...
const UpdateRoom = () => {
    ...
    const {room, error: roomDetailsError, loading: roomDetailsLoading} = useSelector(state => state.roomDetailed);
    ...
    return (
       <>
         {roomDetailsLoading ? <Loader/> :  <div className="container container-fluid">
        <div className="row wrapper">
           <div className="col-10 col-lg-8">
              <form onSubmit={submitHandler} className="shadow-lg" encType="multipart/form-data">
                 ...
                 <button disabled={loading} type="submit" className="btn btn-block new-room-btn py-3">
